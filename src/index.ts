...
const gptImage = async (prompt: string) => {
    try {
...
let conversationLog: Chatlog = [{ role: 'system', content: `Be nice. You are a frinedly bot. Your name is ${botName}` }];
...
let botMode : 'normal' | 'evil' = 'normal'
